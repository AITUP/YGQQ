...
@implementation YGDrawerHeaderView
...
//    [self.backView addGestureRecognizer:tapTwo];
    ...
    self.qrView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"sidebar_QRcode_normal"]];
    ...
    self.iconView.image = [UIImage imageNamed:@"icon_02"];
    ...
    self.nameLable.text = @"等风来";
    self.nameLable.textColor = kWhiteColor;
    self.nameLable.font = Font(32);
    ...
    self.infoLabel.textColor = kWhiteColor;
    self.infoLabel.textAlignment = NSTextAlignmentLeft;
    self.infoLabel.font = [UIFont systemFontOfSize:15];
    self.infoLabel.text = @"这其实就是一个性签名!你可以点一下看一看效果";
...
- (void)layoutSubviews {
    ...
    [self.nameLable mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.mas_equalTo(kLeftDrawerW - 20 - kIconView_W - 20);
    }];
